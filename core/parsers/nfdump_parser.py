...
class NFDumpParser(FileParser):
    def __init__(self, nfdump_command_generator: IOCommandGenerator, serializer_type: str):
        self.__nfdump_command_generator = nfdump_command_generator
        self.__serializer_type = serializer_type

    def parse(self, file: File) -> bytes:
        command_parameters = {"file_name": file.path, "serialize_type": self.__serializer_type}
